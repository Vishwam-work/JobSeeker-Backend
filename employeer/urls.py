...
path('api/companies/<int:pk>/<str:name>/jobs/', views.company_jobs, name='company-jobs'),
...
path('api/profiles/<int:profile_id>/', views.SingleProfileAPIView.as_view(), name='single-profile'),
